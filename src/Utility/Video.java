...
public class Video {
    ...
    public static String getUniqueOutputFilename(String outputDir, String baseName, String extension) {
        int index = 1;
        ...
        return filename; // Just the filename, not full path
    }
    ...
    public static void generateVideo(String framesDir, String outputPath) throws IOException, InterruptedException {
        ...
        String outputFile = getUniqueOutputFilename(outputPath, "output", "mp4");

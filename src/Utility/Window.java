...
//
//        // Set system look and feel for native styling
//        try {
...
//        }
//
//        frame = new JFrame("DSA in 3D - Interactive Visualizer");
//        frame.setSize(Screen.getWidth(), Screen.getHeight());
//        frame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
//        frame.setBackground(new java.awt.Color(18, 18, 24));
//        frame.setForeground(java.awt.Color.WHITE);
//        frame.setLocationRelativeTo(null);
//        frame.setAlwaysOnTop(true);
//
//        // Main content pane with dark theme
...
//                GradientPaint gradient = new GradientPaint(0, 0, new java.awt.Color(15, 15, 25),
//                        getWidth(), getHeight(), new java.awt.Color(25, 25, 35));
...
//
//        // Next step button with modern styling
...
//
//        // Position button in bottom center
//        int buttonWidth = 180;
//        int buttonHeight = 50;
//        nextStepButton.setBounds(
//                (Screen.getWidth() - buttonWidth) / 2,
//                Screen.getHeight() - buttonHeight - 40,
//                buttonWidth,
//                buttonHeight
//        );
//
...
//                nextStepButton.setBackground(new java.awt.Color(100, 180, 255));
//                nextStepButton.setBorder(BorderFactory.createLineBorder(new java.awt.Color(150, 200, 255), 2, true));
//            }
//            public void mouseExited(java.awt.event.MouseEvent evt) {
//                nextStepButton.setBackground(new java.awt.Color(70, 130, 180));
//                nextStepButton.setBorder(BorderFactory.createLineBorder(new java.awt.Color(100, 150, 200), 2, true));
//            }
//        });
//
...
//        layeredPane.add(nextStepButton, JLayeredPane.POPUP_LAYER);
//
//        mainPanel.add(layeredPane, BorderLayout.CENTER);
//        frame.setContentPane(mainPanel);
//
//        // Add subtle window shadow (only works on some platforms)
//        try {
//            frame.setOpacity(0.99f);
//        } catch (Exception e) {
...
//                BorderFactory.createLineBorder(new java.awt.Color(100, 150, 200), 2, true),
